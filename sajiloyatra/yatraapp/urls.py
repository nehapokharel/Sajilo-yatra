...
urlpatterns = [
    ...
    path('events/completed/', views.EventCompleted.as_view(),
         name='event_list_completed'),
    ...
    path('events/completion/<int:pk>',
         views.eventcompletion, name='event_completion'),
    path('contact/', views.contactview, name='contact'),
    path('thanks/', views.thankview, name='thanks'),
    # path('planner',views.PlannerView.as_view(),name='planner'),
    path('planner/add/<slug:models>/<int:pk>',
         views.plannerAdded, name='add_planner'),
